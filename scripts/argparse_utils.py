...
def argparse_init():
    ...
    args.add_argument("-f", "--feed", type=int, help="Get n posts from your Bootlicker feed e.g. -f 10 (number optional)", default=-1, nargs="?")
    ...
    args.add_argument("-gup", "--get-user-posts", type=str, help="Get a user's posts, ALL of their posts, e.g. -gup username")
